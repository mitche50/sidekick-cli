# improving-prompts playbook

## Summary
Iteratively improves prompts and specs using critique, stricter acceptance criteria, and rewrite cycles to raise output quality.
