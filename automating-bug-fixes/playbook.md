# automating-bug-fixes playbook

## Summary
Drives an autonomous bug-fix loop from logs or failing tests to a patch, minimizing micromanagement and emphasizing verification.
