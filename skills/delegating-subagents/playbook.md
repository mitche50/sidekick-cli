# delegating-subagents playbook

## Summary
Decomposes complex tasks into parallel subagent work across separate LLM sessions, then synthesizes results and runs a gatekeeper review.
