# developing-reusable-commands playbook

## Summary
Turns repeated LLM or router workflows into reusable local CLI commands or scripts with docs, safe defaults, and examples.
