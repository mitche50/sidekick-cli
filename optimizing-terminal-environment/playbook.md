# optimizing-terminal-environment playbook

## Summary
Suggests terminal, tmux, and shell ergonomics to speed task switching across worktrees and LLM sessions in local dev workflows.
